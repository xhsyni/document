...
def extract_doc():
    if 'wordFile' in request.files:
        ...
        if file and allowed_file(file.filename):
            ...
            print(f"Does the CSV exist? {os.path.exists(csv_path)}")
                    ...
                    <body>
                        <div class="complete-container">
                            ...
                            <div class="download-card">
                                ...
                                <form method="GET" action="/word/download_csv">
...
@word_extractor_bp.route('/word/download_csv', methods=['GET'])
def download_csv():
    ...
    if os.path.exists(csv_path):
        ...
        return render_template_string("""{{csv_filename}}""",csv_filename=csv_path)
